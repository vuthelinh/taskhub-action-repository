...
public class SupPaymentTabPage extends TH5PageObject {

	public SupPaymentTabPage(WebDriver driver) {
		super(driver);
	}

	private String xAdd = "//td/input[@value='Add'][@type='button']";
	private String xDelete = "//td/input[@value='Delete'][@type='button']";
