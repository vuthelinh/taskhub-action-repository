@vincent @angela @scm @intergration_sq_so_lg_bs_no_segment
Feature: Intergration Test - SQ-SO-LG-LGARI
  ...
  Scenario Outline: Intergration Test - SQ-SO-LG-LGARI
    ...
    Examples: 
      | Sales Quotation KEY | Approving Officer KEY | Approval Summary KEY | Sales Order KEY | Sales Order Variation KEY | DATABASE KEY |
