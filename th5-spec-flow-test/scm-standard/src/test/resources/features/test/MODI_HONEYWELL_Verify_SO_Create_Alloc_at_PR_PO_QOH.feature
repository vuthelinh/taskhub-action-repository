@vincent @adela @scm @modi_honey_well_verify_so_create_alloc_at_pr_po_qoh
Feature: Verify_HONEYWELL_MODI_SO_Create_Alloc_at_PR_PO_QOH
  ...
  Scenario Outline: Verify_HONEYWELL_MODI_SO_Create_Alloc_at_PR_PO_QOH
    ...
    Examples: 
      | Module Config KEY | DB Change KEY | Purchase Order KEY | Sales Order KEY | SQL Statement KEY | Sales Order Variation KEY |
