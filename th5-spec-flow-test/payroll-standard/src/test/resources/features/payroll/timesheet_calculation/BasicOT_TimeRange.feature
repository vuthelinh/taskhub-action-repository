@timesheet_calculation_basicot_timerange @levin @payroll
Feature: Timesheet Calculation Test Suite by Payroll - Salary Type: Basic OT - Time Range

  Scenario Outline: Salary Type: Basic OT - Time Range
...
# Test Flow
    ...
    Examples:
      ...
      | rachel | (TRG3)  | taskhub  | jdbc:db2://172.18.0.10:50000/GENMAIN3 | db2admin | Taskhub1 | TSC_BasicOT_TimeRange_GENMAIN3_Dataset.xls | TSC_BasicOT_TimeRange_GENMAIN3_Dataset_Output_12_04_2016_C.xls | FOT       |
