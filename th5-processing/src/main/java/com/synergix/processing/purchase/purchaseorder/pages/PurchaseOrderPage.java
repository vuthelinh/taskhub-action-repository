 ...
 * @version 20160121
 */
public class PurchaseOrderPage extends TH5PageObject {
	...
	// BEGIN Purchase Order Summary
	private String xPathPanelPOSummary = "(//div[text()='Purchase Order Summary']//ancestor::div[1]//table)[1]";

	public void click_btn_new_of_po_summany() {
		findBtn(xPathPanelPOSummary, "New").waitUntilClickable().click();
	}

	public void click_btn_submit_of_po_summany() {
		findBtn(xPathPanelPOSummary, "Submit").waitUntilClickable().click();
	}
	...
	public void filter_summary_by_po_no(String _PONo) {
		filterDataByHeader(xPathTbHeaderCell(xPathPanelPOSummary, "PO No."), _PONo);
	}

	public void filter_summary_by_pr_no(String _PRNo) {
		filterDataByHeader(xPathTbHeaderCell(xPathPanelPOSummary, "PR No."), _PRNo);
	}

	public void filter_summary_by_alloc_voucher_no(String _AllocVoucherNo) {
		filterDataByHeader(xPathTbHeaderCell(xPathPanelPOSummary, "Alloc Voucher No."), _AllocVoucherNo);
	}

	public void filter_summary_by_created_by(String _createdBy) {
		filterDataByHeader(xPathTbHeaderCell(xPathPanelPOSummary, "Created By"), _createdBy);
	}

	public void filter_summary_by_created_date(String _createdDateFrom, String _createdDateTo) {
		filterDataByHeaderDate(xPathTbHeaderCell(xPathPanelPOSummary, "Created Date From To"), _createdDateFrom,
				_createdDateTo);
	}

	public void filter_summary_by_last_updated_by(String _lastUpdatedBy) {
		filterDataByHeader(xPathTbHeaderCell(xPathPanelPOSummary, "Last Updated By"), _lastUpdatedBy);
	}

	public void filter_summary_by_last_updated_date(String _lastUpdatedDateFrom, String _lastUpdatedDateTo) {
		filterDataByHeaderDate(xPathTbHeaderCell(xPathPanelPOSummary, "Created Date From To"), _lastUpdatedDateFrom,
				_lastUpdatedDateTo);
	}

	public void open_purchase_order_no(String _purchaseOrderNo) {
		int rowIndex = searchInTbMultiPage(xPathPanelPOSummary, "PO No.", 1, _purchaseOrderNo, true);
		int headerIndex = getTbColHeaderIndex(xPathPanelPOSummary, "PO No.");
		clickOnElement(xPathTbDataCellByPosition(xPathPanelPOSummary, rowIndex, headerIndex) + "//a");
	}

	public void open_first_purchase_order_no() {
		int headerIndex = getTbColHeaderIndex(xPathPanelPOSummary, "PO No.");
		clickOnElement(xPathTbDataCellByPosition(xPathPanelPOSummary, 1, headerIndex) + "//a");
	}

	public void open_first_purchase_order_variation_no() {
		int headerIndex = getTbColHeaderIndex(xPathPanelPOSummary, "Variation");
		clickOnElement(xPathTbDataCellByPosition(xPathPanelPOSummary, 1, headerIndex) + "//a");
	}
	...
	// Detail
	String xPathPanelDetail = "//span[contains(@id,'detailTab')]";
	String xPathTbAddDetail = "//form[contains(@id,'poOrderNewDetsForm')]";
	...
	public void switch_to_tab_ad_allocation_details() {
		switch_to_tab(xPathPanelAllocationDetail, "Allocation Details");
	}
	...
	public int get_alloc_row_by_allocation_no(String _allocationNo) {
		return searchInTbMultiPage(xPathPanelAllocationDetail + "//table[contains(@id,'poNewDetAllocTable')]",
				"Allocation No.", 1, _allocationNo, false);
		// return getTbRowIndexOfDataCell(xPathTbDataCellByTextEqualInCol(
		// xPathPanelAllocationDetail +
		// "//table[contains(@id,'poNewDetAllocTable')]", _allocationNo, 1,
		// "Allocation No.", 1));
	}
	...
	// END Create PO
	// BEGIN Outstanding PO
	public String get_ost_purchase_order_no() {
		return getTextWithLabel(xPathPanelPODetail, "Purchase Order No.", 1);
	}
	// END Outstanding PO
}
