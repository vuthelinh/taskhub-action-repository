...
import com.synergix.processing.purchase.purchaseorder.pages.SystemSetupPage;
...
public class SystemSetupSteps extends ScenarioSteps {
	...
	/**
	 * @Description Set setting for purchase order system config. Supported
	 *              config type: Radio,Input,Select,Search,Remarks
	 * @author Vincent
