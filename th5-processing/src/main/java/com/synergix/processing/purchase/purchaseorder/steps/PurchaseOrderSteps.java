...
import com.synergix.processing.purchase.purchaseorder.pages.PurchaseOrderPage;
 ...
 * @version 20160121
 */
public class PurchaseOrderSteps extends ScenarioSteps {
	PurchaseOrderPage purchaseOrderPage;

	// BEGIN Switch tab
	@Step
	public void switch_to_tab_draft() {
		purchaseOrderPage.switch_to_tab_draft();
	}

	@Step
	public void switch_to_tab_outstanding() {
		purchaseOrderPage.switch_to_tab_outstanding();
	}

	@Step
	public void switch_to_tab_completed() {
		purchaseOrderPage.switch_to_tab_completed();
	}

	@Step
	public void switch_to_tab_cancelled() {
		purchaseOrderPage.switch_to_tab_cancelled();
	}
	...
	public void click_btn_new_of_po_summany() {
		purchaseOrderPage.click_btn_new_of_po_summany();
	}

	@Step
	public void click_btn_submit_of_po_summany() {
		purchaseOrderPage.click_btn_submit_of_po_summany();
	}

	@Step
	public void filter_summary_by_po_no(String _PONo) {
		purchaseOrderPage.filter_summary_by_po_no(_PONo);
	}

	@Step
	public void filter_summary_by_pr_no(String _PRNo) {
		purchaseOrderPage.filter_summary_by_pr_no(_PRNo);
	}

	@Step
	public void filter_summary_by_alloc_voucher_no(String _AllocVoucherNo) {
		purchaseOrderPage.filter_summary_by_alloc_voucher_no(_AllocVoucherNo);
	}
	@Step
	public void filter_summary_by_created_by(String _createdBy) {
		purchaseOrderPage.filter_summary_by_created_by(_createdBy);
	}

	@Step
	public void filter_summary_by_created_date(String _createdDateFrom, String _createdDateTo) {
		purchaseOrderPage.filter_summary_by_created_date(_createdDateFrom, _createdDateTo);
	}

	@Step
	public void filter_summary_by_last_updated_by(String _lastUpdatedBy) {
		purchaseOrderPage.filter_summary_by_last_updated_by(_lastUpdatedBy);
	}

	@Step
	public void filter_summary_by_last_updated_date(String _lastUpdatedDateFrom, String _lastUpdatedDateTo) {
		purchaseOrderPage.filter_summary_by_last_updated_date(_lastUpdatedDateFrom, _lastUpdatedDateTo);
	}

	@Step
	public void open_purchase_order_no(String _purchaseOrderNo) {
		purchaseOrderPage.open_purchase_order_no(_purchaseOrderNo);
	}

	@Step
	public void open_first_purchase_order_no() {
		purchaseOrderPage.open_first_purchase_order_no();
	}

	@Step
	public void open_first_purchase_order_variation_no() {
		purchaseOrderPage.open_first_purchase_order_variation_no();
	}
	// END Summary
	// BEGIN Header
	@Step
	public boolean is_display_reports_selection() {
		return purchaseOrderPage.is_display_reports_selection();
	}

	@Step
	public void open_report_by_report_title(String reportTitle) {
		purchaseOrderPage.open_report_by_report_title(reportTitle);
	}

	@Step
	public int count_text_sections_in_report() {
		return purchaseOrderPage.count_text_sections_in_report();
	}
	@Step
	...
	public void click_btn_copy() {
		purchaseOrderPage.click_btn_copy();
	}
	...
	public String get_ost_purchase_order_no() {
		return purchaseOrderPage.get_ost_purchase_order_no();
	}
	// END Outstanding
}
